...
function updateCartModal(){
    ...
    cartTotal.textContent = total.toLocaleString('pt-BR', { //formatando o total 
        style: 'currency', 
        currency: 'BRL'
    });
...
checkoutBtn.addEventListener('click', function(){
 ...
 //Enviar pedido para api do whats]
    ...
    cartItem += `Nome: ${nome} - Contato: ${contato} - Endereço: ${endereco}`
...
Obrigado pela preferência, se precisar de algo é só chamar! :wink:`;
